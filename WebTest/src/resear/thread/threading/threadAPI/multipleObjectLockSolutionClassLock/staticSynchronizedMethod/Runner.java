...
public class Runner {
	public static void main(String[] args) {
		...
		/*More than one object is there of DisplayObject, so Object lock will not prevent the irregular data, therefore make the method
		 static from whom you want to synchronized data.*/
